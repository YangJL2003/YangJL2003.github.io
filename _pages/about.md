...
- Analyzed AgentNet data carefully. **[TODO]**

### **VideoAgentTrek: Extract Agent Trajectories from Hindsight Videos**  
*2024.7 - present*  
*Advised by Prof. [Tao Yu](https://taoyds.github.io/), The University of Hong Kong*  

- Enabled autonomous agents to learn actions from unlabeled online videos, inspired by OpenAI’s Video PreTraining (VPT) methodology.
- Trained an Inverse Dynamics Model (IDM) to transform unlabeled online tutorial videos into valuable pretraining data for autonomous agents.
- Pretrained a vision-language model using large-scale data, resulting in a high-performing autonomous agent capable of effective learning.
...
- Developed a practical application designed for seminar environments, specifically deployed in teaching seminar settings where a substantial amount of feedback is generated.
- Conducted pilot studies and user surveys to grasp the current needs of people for meeting assistance as a guide for our human-centered iterative design.
...
- Pretrained the LM (Language Model) with different iteration counts, using preprocessed data from novels by Louis Cha.
- Fine-tuned the LM with different data volumes and iteration counts, **data synthesis** using an estimate of 400,000 pieces of Q&A data in 12 categories generated by LLM (Large Language Model).
- Built an interactive interface for Q&A with LM, using Gradio.

### **What's the Buzz: Analysis of the Trend of Technology News Popularity on Chinese Websites in 2023**  
*2023.8 - 2023.9*  

- Crawled 8,495 news articles from sina.com from 2023.1 to 2023.8, using tools including Selenium, Requests, and BeautifulSoup.
- Built an information retrieval system, using methods including inverted index, TF-IDF, and tokenization.
- Curated news content by designing a website, using web development tools including Django.
...
- Curiosity, self-drive, and strong teamwork skills
- Experience in pretraining, fine-tuning LM, and agent framework designing
- Programming languages: Python, C/C++
- Experience in PyTorch, NumPy, Pandas, Sklearn
